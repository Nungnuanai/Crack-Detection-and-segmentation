...
def trainGenerator(batch_size,train_path,image_folder,mask_folder,aug_dict,image_color_mode = "grayscale",
                    ...
                    flag_multi_class = False,num_class = 2,save_to_dir = None,target_size = (96,96),seed = 1):   #target_size = (256,256),
...
def testGenerator(test_path,num_image = 354,flag_multi_class = False,target_size = (96,96),as_gray = True):
